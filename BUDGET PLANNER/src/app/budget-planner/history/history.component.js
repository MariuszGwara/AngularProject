...
var HistoryComponent = function () {
    var _classDecorators = [(0, core_1.Component)({
            ...
            standalone: true,
            imports: [forms_1.ReactiveFormsModule, common_1.CommonModule, icon_1.MatIconModule, side_nav_component_1.SideNavComponent],
    ...
    var HistoryComponent = _classThis = /** @class */ (function () {
        function HistoryComponent_1(fb, router) {
            this.fb = fb;
            this.router = router;
            this.expenses = [
        ...
        HistoryComponent_1.prototype.ngOnInit = function () {
        ...
        HistoryComponent_1.prototype.onSubmitExpense = function () {
        ...
        HistoryComponent_1.prototype.onChangeExpense = function (event) {
            this.selectedMonth = event.target.value;
            this.monthSelected = true;
            this.getFilteredExpenses();
        };
        HistoryComponent_1.prototype.getFilteredExpenses = function () {
        ...
        HistoryComponent_1.prototype.calculateTotalExpense = function (month) {
            return this.getFilteredExpenses().reduce(function (acc, curr) { return acc + curr.expenseAmount; }, 0);
        };
        HistoryComponent_1.prototype.onSave = function () {
            if (this.todoForm.valid) {
                this.todoForm.reset({ month: this.selectedMonth });
                this.getFilteredExpenses();
            }
        };
        HistoryComponent_1.prototype.saveForm = function () {
            console.log("Form saved!");
        };
        HistoryComponent_1.prototype.onBack = function () {
